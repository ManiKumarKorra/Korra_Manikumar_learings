...
source_key = 'sample_montly_data/APR_2020.csv'  # Update file name here
destination_bucket_name = 'korramanikumar'
destination_key_prefix = 'transformated_data'
...
copy_to_destination_s3_task = PythonOperator(
    task_id='copy_to_destination_s3',
