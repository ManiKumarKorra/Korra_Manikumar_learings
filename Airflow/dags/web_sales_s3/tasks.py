...
def move_data_to_s3(**context):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        web_sales_data_str = context["ti"].xcom_pull(task_ids='download_from_s3_task', key="downloaded_file")
    ...
    task_instance.xcom_push(key="s3_file_name", value=dest_s3_file_name)