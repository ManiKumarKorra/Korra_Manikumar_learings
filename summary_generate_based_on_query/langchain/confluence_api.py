...
folder = ['2674819117','2674556968']
 
def get_confluence_data(api_token):
    # Confluence API details
    confluence_folder_url = f'https://aris-ziffity.atlassian.net/wiki/rest/api/content/2674819117/child/page?expand=body.view'
    email = 'manikumar.ramakrishna@ziffity.com'
#    https://aris-ziffity.atlassian.net/wiki/spaces/Z2/folder/2674556968
    ...
    if response.status_code == 200:
        ...
        for idx, page in enumerate(data.get('results', [])):
            ...
            file_path = os.path.join(data_folder, f"confluence__GeniAI_pages_{idx}.txt")
